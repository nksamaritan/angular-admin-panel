...
(function() {
  ...
  d.parseDefs = function (a, b) {
    for (var c in a) {
      var e = typeof a[c];
      if (0 < a[c].length && "object" == e) for (var h = 0; h < a[c].length; h++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][h], e); else "object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e),
...
(function() {
  ...
  d.AxisBase = d.Class({
    ...
    handleMouse: function (a, b, c) {
      ...
      var w, x = this.gridAlpha, y, u = this.choosePeriod(0), A = u.period, u = u.count, z = d.getPeriodDuration(A, u);
      ...
      if (0 < this.gridCountR) for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
        ...
        this.pushAxisItem(m);
        m = l = p;
        if (!isNaN(w)) for (h = 1; h < u; h += w) this.gridAlpha = this.minorGridAlpha, f = p + y * h, f = d.resetDateToMin(new Date(f), A, w, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) *
  ...
  d.ValueAxis = d.Class({
    inherits: d.AxisBase, construct: function (a) {
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0; else {
        ...
        var x = this.step, z, A = this.minorGridAlpha;
        ...
        if (this.autoGridCount || 0 !== this.gridCount) if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime =
          ...
          if (!isNaN(z) && 0 < A && g < r - 1) {
            ...
            for (J = 1; J < u; J++) {
              var H = this.getCoordinate(t + z * J), H = new this.axisItemRenderer(this, H, "", !1, 0,
                0, !1, !1, 0, !0);
              this.pushAxisItem(H)
            }
            this.gridAlpha = f
      ...
      for (p = n; p <= l; p++) {
        ...
        for (q = 0; q < k.length; q++) if (n = k[q], n.hidden) n.newStack && (h[p] = NaN, e[p] = NaN); else if (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable) if (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[p] = NaN, e[p] = NaN); else {
          ...
          f[p] = d.roundTo(f[p], w);
          x = n.fillToGraph;
          r && x && (x = this.data[p].axes[this.id].graphs[x.id]) &&
          (m.values.open = x.values.value);
...
(function() {
  ...
  d.RecAxis = d.Class({
    construct: function (a) {
      var b = a.chart, c = a.axisThickness, e = a.axisColor, h = a.axisAlpha, f = a.offset, g = a.dx, k = a.dy, l = a.x,
...
(function() {
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
      ...
      this.set = y;
      var u = a.axisThickness, A = a.axisColor, z = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness,
        J = a.gridColor, H = a.dashLength, S = a.fillColor, O = a.fillAlpha, Q = a.labelsEnabled;
      n = a.labelRotationR;
      var ia = a.counter, I = a.inside, aa = a.labelOffset, va = a.dx, ma = a.dy, Oa = a.orientation, Z = a.position,
        da = a.previousCoord, X = a.height, Aa = a.width, ea = a.offset, fa, Ba;
      g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), Q = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (J = g.lineColor), void 0 != g.color && (w = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha), isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness), !0 === g.inside && (I = !0, 0 < ea && (ea = 0)), isNaN(g.labelRotation) ||
      ...
      var T = n * Math.PI / 180, Y, Da, G = 0, v = 0, na = 0, ha = Y = 0, Pa = 0;
      "V" == Oa && (n = 0);
      var ca;
      ...
      if ("H" == Oa) {
        if (0 <= b && b <= Aa + 1 && (0 < B && 0 < z && b + l <= Aa + 1 && (fa = d.line(x, [b + l, b + l], [0, B], A, z, C), y.push(fa)), 0 < D && (Ba = d.line(x, [b, b + va, b + va], [X, X + ma, ma], J, D, C, H), y.push(Ba))), v = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ga = "start", v = "bottom" == Z ? I ? v + B : v - B : I ? v - B : v + B, G += 3, 0 < h && (G += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == ia && 0 < O && !g && !m && da < Aa && (e = d.fitToBounds(b, 0, Aa), da = d.fitToBounds(da, 0, Aa), Y = e - da, 0 < Y && (Da = d.rect(x, Y, a.height, S, O), Da.translate(e - Y + va, ma), y.push(Da))), "bottom" == Z ? (v += X + r / 2 + ea, I ? (0 < n ? (v =
          ...
          ha / 2 * Math.cos(T)), ca && (f = 0, I && (f = ha / 2 * Math.cos(T)), r + f > Aa + 2 || 0 > r)) ca.remove(), ca = null
      } else {
        ...
        v += r / 2;
        "right" == Z ? (G +=
          va + Aa + ea, v += ma, I ? (f || (v -= r / 2 + 3), G = G - (B + 4) - aa) : (G += B + 4 + u, v -= 2, G += aa)) : I ? (G += B + 4 - ea, f || (v -= r / 2 + 3), g && (G += va, v += ma), G += aa) : (G += -B - u - 4 - 2 - ea, v -= 2, G -= aa);
      ...
      ca && (ca.attr({"text-anchor": ga}), ca.translate(G,
        v, NaN, !0), 0 !== n && ca.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ca), this.label = ca, d.setCN(p, ca, a.bcn + "label"), d.setCN(p, ca, q, !0), g && d.setCN(p, ca, "guide"));
...
(function() {
  ...
  d.AmGraph = d.Class({
    construct: function (a) {
        ...
        if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
          ...
          if (!isNaN(p)) {
            var w = this.valueAxis.getCoordinate(p, this.noRounding) - this.height, w = w * this.valueAxis.rMultiplier,
              x = w * Math.sin(r / 180 * Math.PI), r = w * Math.cos(r / 180 * Math.PI);
            e.push(x);
            d.push(r);
            isNaN(k) && (k = x);
            isNaN(l) && (l = r)
      ...
      var a = this.chart, b = this.id, c = this.index, e = this.data, h = this.chart.container, f = this.valueAxis,
        g = this.type, k = this.columnWidthReal, l = this.showBulletsAt;
      isNaN(this.columnWidth) ||
      (k = this.columnWidth);
      isNaN(k) && (k = .8);
      var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate,
        r = this.columnCount, w = d.toCoordinate(this.cornerRadiusTop, k / 2), x = this.connect, y = [], u = [], A, z,
        B, D, C = this.chart.graphs.length, J, H = this.dx / this.tcc, S = this.dy / this.tcc, O = f.stackType,
        Q = this.start, ia = this.end, I = this.scrollbar, aa = "graph-column-";
      I && (aa = "scrollbar-graph-column-");
      var va = this.categoryAxis, ma = this.baseCoord, Oa = this.negativeBase, Z = this.columnIndex,
        da = this.lineThickness, X = this.lineAlpha,
        Aa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba, ga = this.getGradRotation(),
        T = this.chart.columnSpacing, Y = va.cellWidth, Da = (Y * k - r) / r;
      T > Da && (T = Da);
      var G, v, na, ha = q, Pa = n, ca = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Qa = this.negativeFillColors,
      ...
      if (!(I || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Qa && void 0 == Ja || m))) {
        ...
        t ? (ha = q, Pa = Math.abs(Lb - Ka), ub = q, vb = Math.abs(ib - Ka), hb = tb = 0, f.reversed ? (ca = 0, gb = Ka) : (ca = Ka, gb = 0)) : (Pa = n, ha = Math.abs(Lb - Ka), vb = n, ub = Math.abs(ib - Ka), gb = ca = 0, f.reversed ?
          (hb = p, tb = Ka) : hb = Ka)
      }
      var La = Math.round;
      this.pmx = La(ca);
      ...
      if ("line" == g || "step" == g || "smoothedLine" == g) {
        if (0 < Q) {
          for (L = Q - 1; -1 < L; L--) if (G = e[L], v = G.axes[f.id].graphs[b], na = v.values.value, !isNaN(na)) {
            Q = L;
            break
          }
          if (this.lineColorField) for (L =
                                          Q; -1 < L; L--) if (G = e[L], v = G.axes[f.id].graphs[b], v.lineColor) {
            this.bulletColorSwitched = this.lineColorSwitched = v.lineColor;
            break
          }
          if (this.fillColorsField) for (L = Q; -1 < L; L--) if (G = e[L], v = G.axes[f.id].graphs[b], v.fillColors) {
            this.fillColorsSwitched = v.fillColors;
            break
          }
          if (this.dashLengthField) for (L = Q; -1 < L; L--) if (G = e[L], v = G.axes[f.id].graphs[b], !isNaN(v.dashLength)) {
      ...
      for (L = Q; L <= ia; L++) {
        ...
        var R, P, K, ba, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN,
          pa = NaN, qa = NaN, ra = NaN, sa = NaN, wa = NaN, Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN,
          ta = NaN, ua = void 0, Ma = wb, Va = Ya, Ga = Aa, Ca, xa, Bb = this.proCandlesticks, mb = this.topRadius,
          Fa = q - 1, oa = n - 1, bb = this.pattern;
        ...
        if (Ia) {
          ...
          switch (g) {
            case "line":
              if (isNaN(W)) x || (this.drawLineGraph(y, u, U, V), y = [], u = [], U = [], V = []); else {
                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) y.push(E),
                  u.push(F), jb = E, kb = F;
                wa = E;
                Ea = F;
                ka = E;
              ...
              break;
            case "smoothedLine":
              if (isNaN(W)) x || (this.drawSmoothedGraph(y, u, U, V), y = [], u = [], U = [], V = []); else {
                ...
                la = F;
                !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M));
                void 0 == v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(y, u, U, V), y = [E], u = [F], U = [], V = [], !Ra || isNaN(M) || isNaN(N) || (U.push(N),
                  V.push(M)), this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched = v.dashLength);
                v.gap && (this.drawSmoothedGraph(y, u, U, V), y = [], u = [], U = [], V = [])
              }
              break;
            case "step":
              if (!isNaN(W)) {
                t ? (isNaN(A) || (y.push(A), u.push(F - ya)), u.push(F - ya), y.push(E), u.push(F + Ha), y.push(E), !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B), V.push(M - ya)), U.push(N), V.push(M - ya), U.push(N), V.push(M + Ha))) : (isNaN(z) || (u.push(z), y.push(E - ya)), y.push(E - ya), u.push(F), y.push(E + Ha), u.push(F), !Ra || isNaN(M) ||
                ...
                if ($a || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength)) {
                  var cc = y[y.length - 2], dc = u[u.length - 2];
                  y.pop();
                  u.pop();
                  ...
                  this.fillColorsSwitched = v.fillColors;
                  this.dashLengthSwitched = v.dashLength;
                  m && (Sa ? (this.lineColorSwitched = Aa,
                    this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Qa))
                }
              ...
              if (!isNaN(W)) {
                ...
                if (!(W < Pb && ob < Pb || W > Qb && ob >
                  ...
                  if (t) {
                    ...
                    K = d.roundTo(K, 2);
                    ba = d.roundTo(ba, 2);
                    P < q && 0 < K && (ua = new d.Cuboid(h,
                      ba, K, H - a.d3x, S - a.d3y, Ma, Va, da, Ca, X, ga, w, t, ea, bb, mb, aa), v.columnWidth = Math.abs(ba), v.columnHeight = Math.abs(K))
                  } else {
              ...
              if (!isNaN(ta) && !isNaN(W)) {
                ...
                if (t) {
                  ...
                  if (P < q && 0 < K) {
                    ...
                    !isNaN(ra) && !isNaN(pa) &&
                    F < q && 0 < F && (Xa = d.line(h, Db, [F, F], Ca, X, da), cb = d.line(h, Eb, [F, F], Ca, X, da));
                    ba = E - N;
                  ...
                  if (R < n && 0 < K) {
                    Bb && W >= ta && (Va = 0);
                    var ua = new d.Cuboid(h, K, ba, H,
                      S, Ma, Va, da, Ca, X, ga, w, t, ea, bb, mb, aa), Fb, Gb;
                ...
                ua && (xa = ua.set, v.columnGraphics = xa, fa.push(xa), xa.translate(R, P - da / 2), (v.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)),
                I || (v.x = t ? P + K / 2 : R + K / 2, this.animateColumns(ua, L, E, N, F, M), this.addListeners(xa, v), void 0 !== this.tabIndex && xa.setAttr("tabindex", this.tabIndex)))
              }
              break;
            case "ohlc":
              if (!(isNaN(ta) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                ...
                if (t) {
                  ...
                  if (0 === E && 0 === N && 0 === pa && 0 === ra) continue;
                  if (E ==
                    oa && N == oa && pa == oa && ra == oa) continue;
                  var Hb = F - k / 2, Hb = d.fitToBounds(Hb, 0, q), Sb = d.fitToBounds(F, 0, q), Ib = F + k / 2,
                  ...
                  var ka = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa, 0, Fa), Jb = E - k / 2,
                    Jb = d.fitToBounds(Jb, 0, n), Tb = d.fitToBounds(E, 0, n), Kb = E + k / 2, Kb = d.fitToBounds(Kb, 0,
                    n);
          ...
          if (!I && !isNaN(W)) {
            ...
            if (this.end - this.start <= Ub || 0 === Ub) {
              var Vb = this.createBullet(v, ka, la, L), Wb = this.labelText;
              if (Wb && !isNaN(wa) &&
                !isNaN(wa)) {
              ...
              if ("regular" == O || "100%" == O) {
                ...
                if (Yb) {
                  ...
                  if (Na) {
                    var Zb = Na.getBBox(), $b = Zb.width, ac = Zb.height, db, eb, sb = f.totalTextOffset,
                      bc = f.totals[L];
                    bc && bc.remove();
                    var fb = 0;
      ...
      f && (b = f(a, b));
      if (void 0 !== b && "" !== b) return a = d.text(this.container, b, h, e.fontFamily, c), a.node.style.pointerEvents = "none", d.setCN(e, a, this.bcn + "label"), this.bulletSet.push(a),
        a
      ...
      if (1 < a.length) {
        ...
        w && (t = w);
        var w = h.fillColorsR, x = h.fillColorsSwitched;
        x && (w = x);
        var y = h.dashLength;
        (x = h.dashLengthSwitched) && (y = x);
        var x = h.negativeLineColor, u = h.negativeFillColors, A = h.negativeFillAlphas, z = h.baseCoord;
        ...
        if (0 < g || 0 < A) if (p = a.join(";").split(";"), r = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), r = b.concat(e)) : "radar" == q ? (r.push(0), p.push(0)) : h.rotate ? (r.push(r[r.length - 1]), p.push(z), r.push(r[0]), p.push(z), r.push(r[0]), p.push(p[0])) : (p.push(p[p.length -
        1]), r.push(z), p.push(p[0]), r.push(z), p.push(a[0]), r.push(r[0])) : "xy" == q && (b = h.fillToAxis) && (d.isString(b) && (b = k.getValueAxisById(b)), "H" == b.orientation ? (z = "top" == b.position ? 0 : b.height, p.push(p[p.length - 1]), r.push(z), p.push(p[0]), r.push(z), p.push(a[0]), r.push(r[0])) : (z = "left" == b.position ? 0 : b.width, r.push(r[r.length - 1]), p.push(z), r.push(r[0]), p.push(z), r.push(r[0]), p.push(p[0]))), a = h.gradientRotation, 0 < g && (b = d.polygon(l, p, r, w, g, 1, "#000", 0, a, f), b.pattern(h.pattern, NaN, k.path), d.setCN(k, b, h.bcn + "fill"),
          m.push(b)), u || void 0 !== x) isNaN(A) && (A = g), u || (u = x), f = d.polygon(l, p, r, u, A, 1, "#000", 0, a, f), d.setCN(k, f, h.bcn + "fill"), d.setCN(k, f, h.bcn + "fill-negative"), f.pattern(h.pattern, NaN, k.path), n.push(f), n.click(function (a) {
          h.handleGraphEvent(a, "clickGraph")
        }).mouseover(function (a) {
          h.handleGraphEvent(a, "rollOverGraph")
        }).mouseout(function (a) {
      ...
      if (1 < a.length) {
        ...
        var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR,
          t = this.fillColorsR, r = this.negativeLineColor, w = this.negativeFillColors, x = this.negativeFillAlphas,
          y = this.baseCoord, u = this.lineColorSwitched;
        u && (p = u);
        ...
        0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + y + "," + b[b.length - 1], n +=
      ...
      if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
        ...
        var p;
        "xy" == e.type && this.valueField && (p = this.pattern, a.pattern &&
        (p = a.pattern));
        f = this.bullet;
        a.bullet && (f = a.bullet);
        ...
        l && (p && p.remove(), "function" == typeof l ? (l =
      ...
      if (e.accessible && c.accessibleLabel) {
        var d = e.formatString(c.accessibleLabel,
          b);
      ...
      if (a) {
        var e = {
          type: "rollOutGraphItem", item: a, index: a.index, graph: this,
  ...
  d.ChartCursor = d.Class({
    construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        this.fy = a;
        this.prevLineY != a && (c = this.animationDuration, this.zooming && (c = 0), this.hhLine.stop(), this.hhLine.animate({translate: b + "," + a}, c, "easeOutSine"), this.prevLineY = a, this.prevLineX =
          b)
      }
      ...
      this.zooming && (this.zooming =
        !1, this.selectWithoutZooming ? this.dispatchZoomEvent("selected") : (this.hZoomEnabled || this.vZoomEnabled) && this.dispatchZoomEvent("zoomed"), this.rolledOver && this.dispatchMovedEvent(this.mouseX, this.mouseY));
      ...
      if (this.mouseIsDown) {
        var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3),
          b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c =
      ...
      this.enabled && this.rolledOver && (this.leaveCursor || this.setIndex(void 0),
        this.forceShow = !1, this.hideCursor(), this.rolledOver = !1)
      ...
      if (e) {
        ...
        c.rotate ? d = a : f = a;
        c.rotate ? (this.vvLine &&
        this.vvLine.hide(), this.hhLine && this.hhLine.show()) : (this.hhLine && this.hhLine.hide(), this.vvLine && this.vvLine.show());
        this.updateFullLine();
        this.isHidden = !1;
        ...
        if (n.mouseIsOver) {
          ...
          if (this.resizingRight) {
            if (m) if (a = r - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight), a + e > p + f && (a = p - e + f), 0 > a) this.resizingRight = !1, b = this.resizingLeft = !0; else {
              if (0 === a || isNaN(a)) a = .1;
              g.setAttr("height", a)
            } else if (a = t - c, !isNaN(this.maxWidth) && a > this.maxWidth && (a = this.maxWidth), a + c > q + d && (a = q - c + d), 0 > a) this.resizingRight = !1, b = this.resizingLeft =
              !0; else {
              if (0 === a || isNaN(a)) a = .1;
              g.setAttr("width", a)
            }
  ...
  d.ChartScrollbar = d.Class({
    inherits: d.SimpleChartScrollbar, construct: function (a) {
      ...
      if (a.enabled) {
        ...
        var b = a.chart, c = b.chartData, e = a.categoryAxis, h = a.rotate, f = a.x, g = a.y, k = a.width, l = a.height,
      ...
      if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this); else if (this.skipEvent) this.skipEvent = !1; else {
        var a = this.chart.chartData, b, c;
        b = this.dragger.getBBox();
        var e = b.x, h = b.y, f = b.width, g = b.height, k = this.chart;
        this.rotate ? (b = h, c = g) : (b = e, c = f);
        f = {type: "zoomed", target: this};
        f.chart = k;
        var l = this.categoryAxis, m = this.stepWidth, e = k.minSelectedTime, h = k.maxSelectedTime, g = !1;
        if (l.parseDates && !l.equalSpacing) {
          ...
          l.startOnAxis || (b += m / 2);
          c -= this.stepWidth / 2;
          var n = l.xToIndex(b), q = l.xToIndex(b + c);
    ...
    construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          var r = this.horizontalPadding, w = this.verticalPadding, x = this.pointerWidth, y = this.pointerOrientation,
            u = this.cornerRadius,
          ...
          D < g && (D = g);
          D + C > l && (D = l - C);
          var k = z + w, m = D + r, O = this.shadowAlpha, Q = this.shadowColor, r = this.borderThickness,
...
(function() {
  ...
  d.drop = function (a, b, c, d, h, f, g, k) {
    var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b,
      p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = .8 * b, w = -b / 3, x = b / 3;
    0 === c && (w = -w, x = 0);
    180 == c && (x = 0);
    90 == c && (w = 0);
    270 == c && (w = 0, x = -x);
  ...
  d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
    ...
    g = r(g);
    k = r(k);
    var w = r(g / f * k), x = d.VML, y = 359.5 + f / 100;
    359.94 < y && (y = 359.94);
    h >= y && (h = y);
    var u = 1 / 180 * Math.PI, y = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, z = b + Math.sin(e * u) * f,
      B = c - Math.cos(e * u) * g, D = b + Math.sin((e + h) * u) * f, C = c - Math.cos((e + h) * u) * g,
      J = b + Math.sin((e + h) * u) * k, u = c - Math.cos((e + h) * u) * w,
...
(function() {
  ...
  d.AmLegend = d.Class({
    construct: function (a) {
      ...
      var a = this.chart, b = this.position, c = this.width, e = a.divRealWidth, h = a.divRealHeight, f = this.div,
        g = this.legendData;
      this.data && (g =
        this.combineLegend ? this.legendData.concat(this.data) : this.data);
      ...
      c = void 0 !== c ? d.toCoordinate(c, e) : "right" != b && "left" !=
      b ? a.realWidth : 0 < this.ieW ? this.ieW : a.realWidth;
      ...
      var a =
          this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop,
      ...
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        l || (l = b.customMarker);
        var m = b.container, n = b.markerSize, q = 0, p = 0, t = n / 2;
        if (b.useGraphSettings) {
          ...
          2], h, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, q, "graph-stroke"), k.push(q), a.bullet && (a.hidden || (h = a.bulletColorR), q = d.bullet(m, a.bullet, a.bulletSize, h, a.bulletAlpha, a.bulletBorderThickness, g, a.bulletBorderAlpha)) && (d.setCN(c, q, "graph-bullet"), q.translate(n + 1, n / 2), k.push(q)), t = 0, q = n, p = n / 3; else {
            var r;
            a.getGradRotation && (r = a.getGradRotation(), 0 === r && (r = 180));
            q = a.fillColorsR;
            !0 === a.hidden && (q = h);
            if (k = b.createMarker("rectangle", q, a.fillAlphas, a.lineThickness, h, a.lineAlpha, r, k, a.dashLength)) t =
              n, k.translate(t, n / 2);
            q = n
          }
          d.setCN(c, k, "graph-" + e);
        ...
        g = b.switchType;
        var x;
        g && "none" != g && 0 < n && ("x" == g ? (x = b.createX(),
          x.translate(n / 2, n / 2)) : x = b.createV(), x.dItem = a, !0 !== a.hidden ? "x" == g ? x.hide() : x.show() : "x" != g && x.hide(), b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch = x, m.push(x), d.setCN(c, x, "legend-switch"));
        g = b.color;
        ...
        h = d.massReplace(b.labelText, {"[[title]]": a.title});
        void 0 !== b.tabIndex && (m.setAttr("tabindex", b.tabIndex), m.setAttr("role", "menuitem"),
          m.keyup(function (c) {
            13 == c.keyCode && b.clickMarker(a, c)
          }));
        c.accessible && b.accessibleLabel && (r = d.massReplace(b.accessibleLabel, {"[[title]]": a.title}), c.makeAccessible(m, r));
        r = b.fontSize;
